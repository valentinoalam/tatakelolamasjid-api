...
import { TrialBalanceUpdateManyWithoutLedgerNestedInput } from '../trial-balance/trial-balance-update-many-without-ledger-nested.input';
...
export class LedgerUpdateInput {
    ...
    @Field(() => TrialBalanceUpdateManyWithoutLedgerNestedInput, {nullable:true})
    TrialBalance?: TrialBalanceUpdateManyWithoutLedgerNestedInput;
}
