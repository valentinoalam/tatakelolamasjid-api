...
import { TrialBalanceUncheckedUpdateManyWithoutLedgerNestedInput } from '../trial-balance/trial-balance-unchecked-update-many-without-ledger-nested.input';

@InputType()
export class LedgerUncheckedUpdateInput {
    ...
    @Field(() => TrialBalanceUncheckedUpdateManyWithoutLedgerNestedInput, {nullable:true})
    TrialBalance?: TrialBalanceUncheckedUpdateManyWithoutLedgerNestedInput;
}
