...
import { NestedEnumAcquisitionOriginWithAggregatesFilter } from './nested-enum-acquisition-origin-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAcquisitionOriginFilter } from './nested-enum-acquisition-origin-filter.input';

@InputType()
export class EnumAcquisitionOriginWithAggregatesFilter {
