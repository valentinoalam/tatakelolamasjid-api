...
import { UserNotificationUpdateManyWithoutNotifNestedInput } from '../user-notification/user-notification-update-many-without-notif-nested.input';
...
export class NotificationUpdateInput {
    ...
    @Field(() => UserNotificationUpdateManyWithoutNotifNestedInput, {nullable:true})
    receiver?: UserNotificationUpdateManyWithoutNotifNestedInput;
}
