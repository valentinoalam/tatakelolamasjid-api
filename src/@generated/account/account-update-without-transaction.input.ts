...
import { TrialBalanceDetailUpdateManyWithoutAccountNestedInput } from '../trial-balance-detail/trial-balance-detail-update-many-without-account-nested.input';

@InputType()
export class AccountUpdateWithoutTransactionInput {
    ...
    @Field(() => TrialBalanceDetailUpdateManyWithoutAccountNestedInput, {nullable:true})
    TrialBalanceDetail?: TrialBalanceDetailUpdateManyWithoutAccountNestedInput;
}
