...
import { VendorCreateNestedOneWithoutTransactionInput } from '../vendor/vendor-create-nested-one-without-transaction.input';
...
export class TransactionCreateWithoutPaymentMethodInput {
    ...
    @Field(() => VendorCreateNestedOneWithoutTransactionInput, {nullable:false})
