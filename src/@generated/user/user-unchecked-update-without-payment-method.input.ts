...
import { PositionUncheckedUpdateOneWithoutUserNestedInput } from '../position/position-unchecked-update-one-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutPaymentMethodInput {
    ...
    @Field(() => PositionUncheckedUpdateOneWithoutUserNestedInput, {nullable:true})
    position?: PositionUncheckedUpdateOneWithoutUserNestedInput;
