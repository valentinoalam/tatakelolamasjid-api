...
import { PositionUncheckedUpdateManyWithoutEventNestedInput } from '../position/position-unchecked-update-many-without-event-nested.input';
...
@InputType()
export class EventUncheckedUpdateWithoutParticipantInput {
    ...
    @Field(() => PositionUncheckedUpdateManyWithoutEventNestedInput, {nullable:true})
    crews?: PositionUncheckedUpdateManyWithoutEventNestedInput;
